...
namespace Test.ClientHeaders
{
    class Client
    {
        ...
        static void InitializeClient()
        {
            ...
            _Client.StartWithTimeoutAsync(30, BuildHeaders()).Wait();
        ...
        static NameValueCollection BuildHeaders()
        {
            Console.WriteLine("");
            Console.WriteLine("Building request headers.  Press ENTER on an empty key to exit.");
